# Generated by Django 2.2.16 on 2022-11-19 19:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=100, null=True, unique=True, validators=[reviews.validators.username_validate], verbose_name='Имя пользователя')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.IntegerField(validators=[django.core.validators.MinValueValidator(1, 'Рейтинг выставляется по 10 бальной шкале.'), django.core.validators.MaxValueValidator(10, 'Рейтинг выставляется по 10 бальной шкале.')], verbose_name='Рейтинг')),
